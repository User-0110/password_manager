...
public class BankCategoryActivity extends AppCompatActivity implements PasswordAdapter.OnPasswordClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("start_category", "Экран с банковскими категориями запущен");
        ...
        addPassword.setOnClickListener(v -> {
            ...
            intent.putExtra("database_name", "banks.db");
    ...
    private void updatePasswords() {
        DBManager dbManager = new DBManager(new MyAppSQLiteHelper(this, "banks.db", null, 1));
