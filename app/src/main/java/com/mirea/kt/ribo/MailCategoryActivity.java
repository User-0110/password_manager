...
public class MailCategoryActivity extends AppCompatActivity implements PasswordAdapter.OnPasswordClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.d("start_category", "Экран с почтовыми категориями запущен");
        ...
        addPassword.setOnClickListener(v -> {
            ...
            intent.putExtra("database_name", "mails.db");
    ...
    private void updatePasswords() {
        DBManager dbManager = new DBManager(new MyAppSQLiteHelper(this, "mails.db", null, 1));
