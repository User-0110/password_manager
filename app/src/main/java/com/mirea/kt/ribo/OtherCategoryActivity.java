...
public class OtherCategoryActivity extends AppCompatActivity implements PasswordAdapter.OnPasswordClickListener {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_other_category);

        Log.d("start_category", "Экран с прочими категориями запущен");
        ...
        addPassword.setOnClickListener(v -> {
            ...
            intent.putExtra("database_name", "others.db");
    ...
    private void updatePasswords() {
        DBManager dbManager = new DBManager(new MyAppSQLiteHelper(this, "others.db", null, 1));
